...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroup = findViewById(R.id.countryId);
        radioButtonCh = findViewById(R.id.radioChinaId);
        checkBoxPlay = findViewById(R.id.playId);
        checkBoxEat = findViewById(R.id.eat_foodId);

        //选中按钮变化时调用
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.radioChinaId) {
                    Toast.makeText(MainActivity.this, "你选中了中国", Toast.LENGTH_SHORT).show();
                    checkBoxEat.setChecked(true);
                } else if (checkedId == R.id.radioAmericanId) {
